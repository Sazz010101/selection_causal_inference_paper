...
## Data
* contains 2 files
   * anonymised phenotypic data for the empirical example
   * anonymised pedigree for the empirical example
 
## Code
* contains 2 files
   * code for simulating data for and plotting figures 1, 2, 3 and 4 in the main manuscripot
   * code for running and analysing selection on the empricial data, extracting selection gradients and plotting figures 5 and 6.
 
## Results
* contains models generated for the empirical example + result table from the main manuscript
